function  nonlinear_phase_plane(f1, f2, ax, ay, bx, by, z, t, x_manifold, y_manifold)
...
plot([0, 0], [ax, bx], 'r', 'LineWidth', 1.3, 'DisplayName', '$\dot{x}_1 = 0$'); %nullcline dx/dt = 0 x = 0
